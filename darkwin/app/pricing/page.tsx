...
const plans = [
  {
    ...
    name: "Minimum price",
    price: "$200",
    feature: "", // Add empty string for plans without special feature
    features: [
  ...
  //   index: 2,
  //   name: "Enterprise",
  //   feature: "Contact Us", // This plan has a special feature
  //   price: "Let's Talk!",
  //   features: [
  //     "Fully responsive on all screens",
  //     "React / Next.js / Tailwind CSS code",
          ...
          {plans.map((plan, index) => (
            <div key={plan.name} className="h-full flex flex-col justify-between border rounded-3xl px-6">
              ...
              <div className="flex flex-col items-center">
                ...
                {/* Uncomment these if you bring back the commented-out plans */}
                {/* {index === 1 && (
                  <Link
